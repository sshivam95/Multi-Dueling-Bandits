...
def run_experiment(
    ...
    for name in algorithm_name:
        ...
        np.save(f"Regret_results_theta_bar_feedback_correction_50_framework_v2//regret_{name}_{solver}_{subset_size}.npy", regrets)
        np.save(
            f"Execution_times_results_theta_bar_feedback_correction_50_framework_v2//execution_time_{name}_{solver}_{subset_size}.npy",
            execution_times,
        )
