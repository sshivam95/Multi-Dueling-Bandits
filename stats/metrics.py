...
class Regret(Metric):
    ...
    :class:`Cumulative<stats.metrics.Cumulative>` wrapper for that purpose.
    ...
    aggregation_function
        ...
        :class:`AverageRegret<stats.metrics.AverageRegret>`, :class:`StrongRegret<stats.metrics.StrongRegret>` and :class:`WeakRegret<stats.metrics.WeakRegret>`.
...
class AverageRegret(Regret):
    ...
    average of the :term:`regret` of the two pulled arms. Also see :class:`Regret<stats.metrics.Regret>`,
    :class:`StrongRegret<stats.metrics.StrongRegret>` and :class:`WeakRegret<stats.metrics.WeakRegret>`.
...
class StrongRegret(Regret):
    ...
    The :term:`regret` of pulling an arm is defined by the calibrated preference
    probability of the best arm over the pulled one. This metric takes the
    maximum of the :term:`regret` of the two pulled arms. Also see :class:`Regret<stats.metrics.Regret>`,
    :class:`AverageRegret<stats.metrics.AverageRegret>` and :class:`WeakRegret<stats.metrics.WeakRegret>`.
...
class WeakRegret(Regret):
    ...
    The :term:`regret` of pulling an arm is defined by the calibrated preference
    probability of the best arm over the pulled one. This metric takes the
    minimum of the :term:`regret` of the two pulled arms. Also see :class:`Regret<stats.metrics.Regret>`,
    :class:`AverageRegret<stats.metrics.AverageRegret>` and :class:`StrongRegret<stats.metrics.StrongRegret>`.
...
class Cumulative(Metric):
    ...
    Metrics like the :class:`average regret<stats.metrics.AverageRegret>` are often reported in accumulated form.
